...
impl bpf_map {
    ...
    rust_shim_kernel_impl!(pub, bpf_map, name, *mut ::core::ffi::c_char);
}
...
impl bpf_prog_aux {
    ...
    rust_shim_kernel_impl!(pub, bpf_prog_aux, attach_func_name, *const ::core::ffi::c_char);
    rust_shim_kernel_impl!(pub, bpf_prog_aux, name, *mut ::core::ffi::c_char);
}
...
impl bpf_prog {
    rust_shim_kernel_impl!(pub, prog_type, bpf_prog, prog_type, u32);
    rust_shim_kernel_impl!(pub, bpf_prog, aux, bpf_prog_aux);
}

#[allow(non_camel_case_types)]
pub type bpf_attr = CoRe<r#gen::bpf_attr>;

impl bpf_attr {
    rust_shim_kernel_impl!(pub, bpf_attr, prog_type, u32);
    rust_shim_kernel_impl!(pub, bpf_attr, prog_name, *mut ::core::ffi::c_char);
}
