...
pub type inode = CoRe<shim::inode>;
...
#[allow(non_camel_case_types)]
pub type dentry = CoRe<shim::dentry>;
...
#[allow(non_camel_case_types)]
pub type super_block = CoRe<shim::super_block>;
...
#[allow(non_camel_case_types)]
pub type mount = CoRe<shim::mount>;
...
#[allow(non_camel_case_types)]
pub type vfsmount = CoRe<shim::vfsmount>;
...
#[allow(non_camel_case_types)]
pub type mountpoint = CoRe<shim::mountpoint>;
